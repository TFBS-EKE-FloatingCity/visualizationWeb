...
Connection String Form: ´ws://{static IP-address Raspberry}:{defined port}´
Connection String Example: ´ws://192.168.1.1:8080´

The websocket client connects to the Raspberry.
...
The browser(client) connects to the websocket server.
