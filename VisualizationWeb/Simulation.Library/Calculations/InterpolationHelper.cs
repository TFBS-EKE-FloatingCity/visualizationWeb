...
namespace Simulation.Library.Calculations
{
   public static class InterpolationHelper
   {
      ...
      /// <summary>
      ///   Linearly interpolates between a and b by x. Used when the Factor is known but the Value
      ///   is unknown.
      /// </summary>
      ...
      /// <summary>
      ///   Linearly interpolates between a and b by x. Used when the Value is known but the Factor
      ///   is unknown.
      /// </summary>
      /// <param name="min"> The 0% value </param>
      /// <param name="max"> The 100% value </param>
