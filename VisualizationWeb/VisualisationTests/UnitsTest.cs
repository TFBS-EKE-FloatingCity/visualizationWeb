...
namespace VisualisationTests
{
   ...
   public class UnitsTest
   {
      ...
      {
         double result = UnitConverter.PrefixToNumber("100");
      ...
      {
         double result = UnitConverter.PrefixToNumber("999");
      ...
      {
         double result = UnitConverter.PrefixToNumber("1kw");
      ...
      {
         double result = UnitConverter.PrefixToNumber("1,5kw");
      ...
      {
         double result = UnitConverter.PrefixToNumber("1,5mw");
      ...
      {
         double result = UnitConverter.PrefixToNumber("2,7gw");
      ...
      {
         string result = UnitConverter.NumberToPrefix(0.5);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1000);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1000000);
      ...
      {
         string result = UnitConverter.NumberToPrefix(999999);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1000000000);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1000000000000);
      ...
      {
         string result = UnitConverter.NumberToPrefix(1500000000000);
