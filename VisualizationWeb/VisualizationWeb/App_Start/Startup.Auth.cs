   ...
   public partial class Startup
   {
      ...
      public void ConfigureAuth(IAppBuilder app)
      {
         ...
         app.UseCookieAuthentication(new CookieAuthenticationOptions
         {
            ...
            {
               // Enables the application to validate the security stamp when the user logs in. This
               // is a security feature which is used when you change a password or add an external
         ...
         // or email. Once you check this option, your second step of verification during the login
         // process will be remembered on the device where you logged in from. This is similar to
         // the RememberMe option when you log in.
