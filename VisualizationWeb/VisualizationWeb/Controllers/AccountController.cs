...
namespace VisualizationWeb.Controllers
{
   public class AccountController : Controller
   {
      ...
      public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
      {
         ...
         // This doesn't count login failures towards account lockout To enable password failures to
         // trigger account lockout, change to shouldLockout: true
      ...
      public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
      {
         ...
         // user enters incorrect codes for a specified amount of time then the user account will be
         // locked out for a specified amount of time. You can configure the account lockout
